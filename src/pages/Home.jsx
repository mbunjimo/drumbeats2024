            ...
            <main className="flex-1">
               ...
               <section className="wrapper bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10">
                    <div className='flex w-full justify-center'>
                        <p className='text-2xl text-center'>All About Ruvuma Utamaduni Festival, September 23 <sup>rd</sup> 2024. Countdown to the carnival.</p>
                    </div>
